...
> 最后更新：2026-09-14（R2-16 合集编辑/草稿 + R2-18 用户体验升级 A/B/C/D/E 已交付）
>
...
- **2026-09-14 R2-18F1 验收修复增量（覆盖下文旧身份）**：runtime `06e0451cffd055b8e8f41c2cdac633fe4e1dc2e7`，release `r2-18f1-06e0451-20260914T063914Z`，image `sha256:f150008212d15d98ef460526b0758d0dd492234de482471a8399f0d80a31d964`，source manifest `f938a378725f1347c1697d7a74fc7f9169d37fba37928040eecccfc51ffdedd5`。449 tests，migration=none/schema v14不变；独立后验 healthy/restart0/单实例/error0/quick_check ok/blockers空，rollback-check passed。已修复确认校验失败继续提交、预览雪花/版本/发送超时、撤销结果展示；已有合集时再发入口拒绝冒充空合集。**不能声称仅剩实机验收**：同款再发 draft-scoped 风格和更完整冻结恢复等 F2 未完成，见 [R2-18F_ACCEPTANCE_FIXES.md](docs/refactor-v2/R2-18F_ACCEPTANCE_FIXES.md)。

- **2026-09-14 R2-16 + R2-18 增量（覆盖下文 R2-15B runtime 身份）**：R2-16 合集编辑/多草稿与 R2-18 用户体验升级 A（首页）/B（结果卡/收藏/分享/安静模式）/C（发布风格/最终六键键盘）/E（整理建议）/D（有界效果预览）已全部实现并部署。最终生产 full commit `1a9b86c179595861a53dc2fb28307987df3bdcae`，release `r2-18d-1a9b86c-20260914T040154Z`，runtime image `sha256:63d3096f926fcd11b759fc8de18397e120c2d8889339ecd64033119899b511d4`，Git/宿主/容器 source manifest `3ee01cc3d0e80098397a6fa7322e1f952582d0e1babcbefc4be6001a746efb12`。各阶段：R2-16 `8cd0ac1`/`0012_collection_editing`（v12）；R2-18B `bd7ae31`/`0013_owner_favorites`（v13）；R2-18C `01f9dbc`（migration=none）；R2-18E `5a917b0`/`0014_suggestion_and_preview`（v14）；R2-18D `1a9b86c`（migration=none）。最终 **446 tests** 全绿；每包独立 postflight healthy、restart=0、单实例、error=0、jobs=0、blockers=[]、quick_check=ok，rollback-check passed。R2-17 完整精确重复审核仍未实现（18E 只有规则化“疑似重复”）；仅剩真实 Android/iOS 实机验收。证据见 [R2-18_UX_RELEASE.md](docs/refactor-v2/evidence/R2-18_UX_RELEASE.md) 与 [R2-18A_RELEASE.md](docs/refactor-v2/evidence/R2-18A_RELEASE.md)，Mini App 仅设计见 [R2-18_MINIAPP_DESIGN.md](docs/refactor-v2/R2-18_MINIAPP_DESIGN.md)；下文 R2-15B 身份与 405 tests 为上一基线，不覆盖本增量。
...
- R2-01～R2-06 已恢复 Git 权威、可复现发布链、移动端 UX、checksum migration、durable scheduler/intake/control、自动恢复、SQL 任务/失败中心、通用 operation token 与可恢复撤销。R2-07A1 single Archive profile/policy、A2 durable recovery/status UI、A3 exact remote Archive delete、D Diagnostic Snapshot / 静态代理脱敏状态、R2-09 只读 Dashboard/metrics/通知 outbox、R2-08 Bot UI 热点拆分、R2-11 owner 告警/合集预览、R2-12 归档慢后端容错、R2-13 短路径归档/每日清空/运行时开关、R2-14 视频元数据/缩略图修复与 R2-15 安全历史保留/每业务日展示编号已于 2026-09-13/14 正式发布，R2-07/R2-09 收口且所有 `REQUIRED` 合同为 `VERIFIED`。生产 runtime full commit 为 `75e6259e9212e46e002e0ce2d3b5abb22f606d8f`，release 为 `r2-15b-75e6259-20260914T012823Z`（R2-09 以 `0008_notification_outbox` 推进到 v8，R2-13 以 `0009_archive_layout_flags` 推进到 v9，R2-15A 以 `0010_safe_history_maintenance` 推进到 v10，R2-15B 以 `0011_display_identity` 推进到 v11；R2-12/R2-14 为 migration=none）；退役旧树仍由 annotated tag `legacy-telegram-video-forwarder-750b3c1` 保留。证据见 [`R2-07A1_ARCHIVE_PROFILE_RELEASE.md`](docs/refactor-v2/evidence/R2-07A1_ARCHIVE_PROFILE_RELEASE.md)、[`R2-07A2_ARCHIVE_RECOVERY_RELEASE.md`](docs/refactor-v2/evidence/R2-07A2_ARCHIVE_RECOVERY_RELEASE.md)、[`R2-07A3_ARCHIVE_DELETE_RELEASE.md`](docs/refactor-v2/evidence/R2-07A3_ARCHIVE_DELETE_RELEASE.md)、[`R2-07D_RELEASE.md`](docs/refactor-v2/evidence/R2-07D_RELEASE.md)、[`R2-09_RELEASE.md`](docs/refactor-v2/evidence/R2-09_RELEASE.md)、[`R2-08_RELEASE.md`](docs/refactor-v2/evidence/R2-08_RELEASE.md)、[`R2-08B_RELEASE.md`](docs/refactor-v2/evidence/R2-08B_RELEASE.md)、[`R2-11_RELEASE.md`](docs/refactor-v2/evidence/R2-11_RELEASE.md)、[`R2-12_RELEASE.md`](docs/refactor-v2/evidence/R2-12_RELEASE.md)、[`R2-13_RELEASE.md`](docs/refactor-v2/evidence/R2-13_RELEASE.md) 与 [`R2-14_RELEASE.md`](docs/refactor-v2/evidence/R2-14_RELEASE.md) 与 [`R2-15_RELEASE.md`](docs/refactor-v2/evidence/R2-15_RELEASE.md)。后续 docs-only closure commit 可以领先生产 runtime commit，但不因此构建或重启。
- HostDZire shared root 为 `/root/TGVIO`，current symlink 为 `/root/TGVIO-current`，Compose service/容器为 `tgvio`，包名为 `src/tgvio`。生产 `.release-commit` 与容器 `APP_COMMIT` 均为上述 full commit，runtime image ID 为 `sha256:63d3096f926fcd11b759fc8de18397e120c2d8889339ecd64033119899b511d4`；容器 `running`、health=`healthy`、restart=0、单实例。Git/宿主/容器规范化 Python 源码 manifest 均为 `3ee01cc3d0e80098397a6fa7322e1f952582d0e1babcbefc4be6001a746efb12`。R2-15 推进到 v10/v11，R2-16 推进到 v12，R2-18B 推进到 v13，R2-18E 推进到 v14，schema hash 为 `ef4930f53f2f3acaf515fee376676ea4d1b6c418f89fa5da47f1be57189924e8`；R2-18C/R2-18D 为 migration=none。
- 当前生产 SQLite 是 `/root/TGVIO/data/state.sqlite3`：`quick_check=ok`，`jobs=0`（R2-13 每日 06:00 已清理旧记录，R2-15 起不再物理删除），所有业务 blocker 为 0；migration ledger 已连续登记 1～14，`PRAGMA user_version=14`，schema hash 为 `ef4930f53f2f3acaf515fee376676ea4d1b6c418f89fa5da47f1be57189924e8`。`0012_collection_editing`/`0013_owner_favorites`/`0014_suggestion_and_preview` 均已通过生产副本 rehearsal；部署后新表 `collection_drafts`/`collection_entry_edits`/`collection_submissions`/`editing_interactions`/`favorites`/`suggestion_applications`/`preview_requests` 初始均为 0。任何后续 schema 变化仍必须新增不可变 migration，并先做生产副本演练。
- 当前 R2-18D 正式 clean/pushed test image 在 `--network none` 下 **446 tests 全通过**；测试容器未启动 Bot。runtime image 离线检查继续通过，无 tests、bytecode、构建工具、秘密或运行数据。R2-07D/R2-09 覆盖固定 DiagnosticSnapshot 白名单 DTO、3 条有界 SQL 聚合、1000+ Job 不加载历史、release/schema/lease/scheduler/Archive/feature 脱敏投影、静态代理有界 TCP 探测（凭据/端点不入结果）、离线 `--check` 不连网的 `configured_unchecked`、只读 Dashboard DTO 脱敏、HTTP 认证/方法/安全头、metrics 低基数，以及 outbox 幂等/claim lease/退避/dead-letter/HMAC；R2-08 覆盖 mixin 拆分与 1000 行源文件预算；R2-11 覆盖 owner 告警脱敏/冷却/主次渠道与合集预览确认前不入队；R2-12/R2-13 覆盖归档慢后端容错、发布竞态修复、短路径布局（每日序号）与每日 06:00 安全维护/运行时开关；R2-14 覆盖 ffprobe 视频属性、缩略图空白帧排除与 1MB 预算、仅终态失败告警、环境能力自检；R2-15 覆盖安全隐藏/历史筛选、durable maintenance run（lease/generation、冻结目标、有界状态卡删除、过期 token/outbox 回收）、`job_display_identity` 分配/回填/业务日解析与按业务日统计；R2-16 覆盖草稿 overlay/revision CAS/冻结提交幂等与旧入口兼容；R2-18 覆盖结果卡/链接策略/收藏/安静模式、风格冻结、整理建议撤回与有界效果预览（大小/超时/缓存清理/启动中断）。当前生产 Bot、发布、受控 fixture、URL 和 Archive 非敏感开关均为 enabled；owner 告警、合集预览与每日安全维护默认开启；`/diag` 显示 `ffmpeg/ffprobe/yt-dlp/cryptg=true, hachoir=false`；`TGVIO_STATIC_PROXY_URL` 未配置，`/diag` 显示 `disabled`；`TGVIO_DASHBOARD_ENABLED`/`TGVIO_WEBHOOK_ENABLED` 未设置，无 8787 监听端口。
...
- 正式发布只能从 clean、已推送的 `origin/main` 运行 `scripts/deploy_hostdzire.py`；dirty worktree 只能做无网络诊断构建。R2-07A1/A2/A3/D、R2-09、R2-08、R2-11、R2-12、R2-13、R2-14、R2-15 与 R2-16/R2-18 已交付，所有 `REQUIRED` 合同 `VERIFIED`；固定单一发布目标，动态 Destination Profiles 与 Proxy Profiles 已由用户明确退役，代理只保留环境变量、启动检测和脱敏状态。R2-04E 大文件性能、R2-05 合集交互和 R2-06 真实撤销仍需受控生产验收；R2-10 自动化收口已交付（旧树退役、release 身份与回滚资产验证），受控生产 smoke 与破坏性回滚演练待 owner 窗口，清单见 [`R2-10_CLOSURE.md`](docs/refactor-v2/evidence/R2-10_CLOSURE.md)。不得绕过 partial/uncertain 外部副作用保护。HostDZire 当前 `ntp_synchronized=no`，应在独立运维窗口修复。
...
- 决策：不继续 Telegram 个人账号会话、双客户端监听或 50 视频批次方案；该方案已作废，后续 Agent 不得按旧个人账号会话方案实现或提交。
- 基础退役：`b60f859 refactor: retire automatic sources` 已位于 `main` / `origin/main`。该提交移除了 `/sources` 顶层命令、首页/设置入口、source handlers/runtime/service/view、startup/shutdown source runtime 集成，以及目的地禁用时对 enabled source 的阻塞检查；README 和 `todo.md` 已同步为“不提供自动监听来源频道功能”。
- Demo/文档收口：`55baaad297bcd8b32383fe739bb1b05f42d90ddc`（`docs: finalize automatic source retirement`）已推送 `origin/main`，清理 `demo/o1-dashboard-taste.html` 残留 `/sources` 命令、来源配置面板、mock 来源数据和 `DP1 + S1` 展示文案；demo 现在与只读 Dashboard 契约一致，只保留发布目标路由展示，`/api/v1/routing` 兼容字段 `sources` 仍为空数组。
- 本地验证：抽取出的 dashboard inline script 通过 `node --check`；`git diff --check` 通过；demo 已对退役入口、旧来源面板、旧 mock 来源和旧路由副标题做无命中检查；AGENTS 已对旧方案标题、文件清单和门禁段落做无命中检查；使用项目依赖镜像运行 targeted 21 tests 通过，离线 clean-app 候选镜像内完整 **284 tests** 通过，镜像 runtime/secret path 检查 clean。
- 构建：本地标准 build 两次在 Docker Hub `python:3.11-slim` manifest 解析阶段被拒绝，未进入项目代码构建步骤；本地按既有降级方式用已验证应用镜像作为离线 base 构建 `telegram-video-forwarder-bot:55baaad` 并完成验证。VPS 标准 build 成功，生产镜像 `telegram-video-forwarder-bot:latest` image id `sha256:03e09682e66b2ece22ecd324fc0ea87b46cca0255e2d7ce8f355f9bb09988ac6`，镜像 `APP_COMMIT=55baaad297bcd8b32383fe739bb1b05f42d90ddc`。
- 生产发布：发布前只读确认旧容器 `APP_COMMIT=b60f859`、running/healthy、restart=0、SQLite integrity ok、schema `1..11`、active jobs/claims/backups/source-open 均为 0、source profile enabled=0。发布包 `/root/telegram-video-forwarder-releases/tvf-55baaad-20260901T143854Z.tar.gz`，SHA-256 `7bef01ca1a48d9ff8a58a497c9f3c105bc4490b807be7a74896b476ce6ddbaea`，不含 `.env/session/downloads/.git`。生产 `.env` 仅同步非敏感 `APP_COMMIT`。
- 回滚点：SQLite online backup `/root/telegram-video-forwarder/session/state.sqlite3.pre-55baaad-20260901T143854Z.bak`；source backup `/root/telegram-video-forwarder-releases/source-pre-55baaad-20260901T143854Z.tar.gz`；env backup `/root/telegram-video-forwarder-releases/env-pre-55baaad-20260901T143854Z.bak`（600 权限，未输出内容）；image tag `telegram-video-forwarder:rollback-pre-55baaad-20260901T143854Z`。
- 生产后验：单次 `docker compose up -d --force-recreate --no-build bot` 后容器 running/healthy、restart=0、`APP_COMMIT=55baaad297bcd8b32383fe739bb1b05f42d90ddc`；SQLite integrity ok、schema `1..11`、active jobs/claims/backups=0、source profile enabled=0、source open events=0。Dashboard shell=200、匿名 health=401、Bearer health/metrics=200；宿主/容器 `AGENTS.md` 与 `demo/o1-dashboard-taste.html` SHA-256 一致；近 10 分钟日志 error markers=0、启动标记正常；容器内 `py_compile`、targeted 21 tests 和完整 **284 tests** 均通过。
...
- 当时下一步：锁依赖、增加 test/runtime targets、专用 SSH key、pinned known_hosts 和 fail-closed 一键发布；该工作已由下节 R2-02 完成。

### 2026-09-11 - R2-02 可复现构建与强制交付链

- 状态：R2-02 已交付。实现 commits `a7db291f580bac7348f00cef77643643f1d1d343`、`569926b53af19539b118daa93f95c58da2001637` 已推送 `origin/main`；DP-02 已由生产证据改为 `VERIFIED`。
- 构建：固定 base digest、hashed dependency lock、多阶段 test/runtime targets、Compose placeholder、archive/source/schema/image 门禁和机器可读 manifest 已接管 release。正式 test image 在 `--network none` 下运行 156 tests（9.569s）全绿且未启动 Bot；runtime image 的 46-file/7-package 检查通过。
- 发布：唯一入口从 pushed Git archive 构建 release `r2-02-569926b-20260911T063133Z`，在三次 fail-closed preflight 与三重回滚点后只 recreate 唯一 `tgvio` service 一次。`/root/TGVIO-current` 指向版本化 source；shared 运行卷未覆盖。
- 生产后验：容器 `running/healthy`、restart=0、单实例；full `APP_COMMIT`、release metadata、runtime image ID 与 source manifest 精确匹配。启动和 Telegram-ready 标记存在，无 error marker。SQLite `quick_check=ok`，13 个 Job、`user_version=0` 和 schema hash 均未改变，所有 deploy blocker 为 0。
- 回滚：SQLite backup、脱敏 source archive、远端 0600 `.env` 副本和 previous image tag 已验证；`scripts/rollback_hostdzire.sh --check r2-02-569926b-20260911T063133Z` 通过，未执行真实回滚。证据见 `docs/refactor-v2/evidence/R2-02_RELEASE.md`。
- 安全：专用受限 SSH key 与 pinned ED25519 known-host 已接管远端访问；GitHub 私有 ref 验证只通过短生命周期隐藏认证。此前在会话中暴露的 SSH 密码和 GitHub tokens 未进入仓库/镜像/记录，仍必须轮换或撤销。
- 下一步：R2-03 先在生产 SQLite 副本建立精确 schema fixture、backup/checksum migration runner 和 baseline ledger，再拆 repository；在演练通过前禁止修改生产 schema。
