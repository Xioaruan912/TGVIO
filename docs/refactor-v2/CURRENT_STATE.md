...
2. **功能兼容仍有缺口**：R2-05 已恢复合集会话/文字与 spoiler 偏好但仍需真实交互验收；R2-04E 仍待 1～3 个真实大文件观测。R2-06 automatic recovery、hold/resume 与 SQL paged failure center 已上线，但 operation token、undo，以及动态 Archive、多目的地、代理和 Dashboard 仍为后续合同项。
