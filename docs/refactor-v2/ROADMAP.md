...
2026-09-14 实时核查：R2-15 已交付，R2-16/R2-17 尚未实现。新增 [R2-18 用户体验升级](R2-18_UX_UPGRADE.md)，先做独立首页包，再补 R2-16 前置编辑，继续结果卡、风格、效果预览与整理建议；不得假设依赖已完成。

2026-09-14 状态校正：R2-15 已交付；R2-16 合集编辑、R2-17 重复内容提示仍只有设计。详细数据模型、事务、交互、迁移和验收见 [技术方案](R2-15_16_17_TECHNICAL_PLAN.md)。

R2-18A 首页基础包已交付（`c7ba056`，2026-09-14，migration=none，409 tests）；R2-18 整体仍 IN PROGRESS，后续见 [交接](R2-18_HANDOFF.md)。
...
| R2-18 | IN PROGRESS | A 首页基础包已交付；结果卡/收藏/风格/效果预览/整理建议待实现 | R2-16 前置编辑 |
