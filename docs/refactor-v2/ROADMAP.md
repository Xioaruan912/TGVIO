...
2026-09-14 新增设计：P0 R2-15 安全清理与历史保留 → P1 R2-16 合集编辑 → P1 R2-17 重复内容提示。三个代码阶段均为 `NOT STARTED`，详细数据模型、事务、交互、迁移和验收见 [技术方案](R2-15_16_17_TECHNICAL_PLAN.md)。历史阶段状态不因本次规划而改变。
