...
| R2-07 | IN PROGRESS | A1 单一 Archive Profile/策略冻结已生产交付 v6；后续 A2/A3 与安全诊断摘要继续 | AR-07、OB-01、ST-04 |
...
2026-09-13 当前进度：A1 characterization + single Archive profile/policy 已随 `r2-07-eadd4c9-20260913T023949Z` + `0006_archive_profile_policy` 正式把生产推进到 v6。A2 durable retry/status UI 已随 `r2-07-2a07470-20260913T025845Z` 以 migration-free 方式正式发布：probe failure durable checkpoint、最后成功 capability freshness、精确失败对象 token 绑定与 Archive 手机状态页已上线；正式 release gate 318 tests、独立 postflight 与 rollback-check 通过，schema hash 仍为 `f4ac2877aa0379c249d703a908e4697ba4495ac183aa2450f7ffaa7897e0a244`。R2-07 继续 `IN PROGRESS`，下一包为 A3 exact remote delete。证据见 [R2-07A1_ARCHIVE_PROFILE_RELEASE.md](evidence/R2-07A1_ARCHIVE_PROFILE_RELEASE.md) 与 [R2-07A2_ARCHIVE_RECOVERY_RELEASE.md](evidence/R2-07A2_ARCHIVE_RECOVERY_RELEASE.md)。
