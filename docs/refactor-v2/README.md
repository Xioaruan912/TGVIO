...
> 状态：R2-00～R2-03、R2-05 已交付；R2-04 A-E 已正式发布，但 bounded concurrent upload 仍待 1～3 个真实大文件 performance acceptance 后关闭阶段（2026-09-12）
...
- 当前生产 release 为 `r2-05-342cec3-20260912T125804Z`，runtime commit 为 `342cec36733d69c72e4d5b723be0a76901bca6c0`；`0003_intake_collections` 已把生产推进到 `user_version=3`，240 tests、独立 postflight 与 rollback asset check 均通过。证据见 [R2-05_RELEASE.md](evidence/R2-05_RELEASE.md)。
