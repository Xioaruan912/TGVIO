...
> 状态：R2-00～R2-03、R2-05～R2-09、R2-11～R2-16 已交付；R2-18 用户体验升级（A/B/C/D/E）已交付，仅剩真实手机验收；R2-04 A-E 已正式发布但仍待 1～3 个真实大文件 performance acceptance（2026-09-14）
...
- [R2-18_UX_UPGRADE.md](R2-18_UX_UPGRADE.md)：手机端用户体验升级方案（已交付；仅剩真实手机验收）。
...
- 当前生产 release 为 `r2-18d-1a9b86c-20260914T040154Z`，runtime commit 为 `1a9b86c179595861a53dc2fb28307987df3bdcae`；生产 schema 为 `user_version=14`，hash `ef4930f53f2f3acaf515fee376676ea4d1b6c418f89fa5da47f1be57189924e8`，migration ledger `1..14`。R2-16（`0012_collection_editing`）交付合集草稿编辑；R2-18B（`0013_owner_favorites`）结果卡/收藏/分享/安静模式；R2-18C（migration=none）发布风格与最终六键键盘；R2-18E（`0014_suggestion_and_preview`）整理建议；R2-18D（migration=none）有界效果预览。446 tests 全绿、逐包独立 postflight 与 rollback-check 通过。证据见 [R2-18_UX_RELEASE.md](evidence/R2-18_UX_RELEASE.md)。
