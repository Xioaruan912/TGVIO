...
> 状态：R2-00～R2-03、R2-05～R2-09、R2-11～R2-15 已交付；R2-04 A-E 已正式发布但仍待 1～3 个真实大文件 performance acceptance（2026-09-14）
...
- 当前生产 release 为 `r2-15b-75e6259-20260914T012823Z`，runtime commit 为 `75e6259e9212e46e002e0ce2d3b5abb22f606d8f`；生产 schema 为 `user_version=11`，hash `344e92de1828579e46afe9df40c00ccc0eab10028718ab2d70b8aa7bb896ed6d`，migration ledger `1..11`。R2-15A（`r2-15a-46ae55f-20260914T011949Z`，`0010_safe_history_maintenance`）停止 destructive purge，改为按北京时间 06:00 边界安全隐藏已结算 Job 并保留全部历史/恢复凭据；R2-15B（`0011_display_identity`）引入每业务日展示编号与按业务日统计。405 tests 全绿、独立 postflight 与 rollback-check 通过。证据见 [R2-15_RELEASE.md](evidence/R2-15_RELEASE.md)。
