...
- 当前生产 release 为 `r2-08-c39fe9d-20260913T094000Z`，runtime commit 为 `c39fe9d579d86e73c1505741606221408e0b5fd2`；生产 schema 仍为 `user_version=8`，hash `5b80e9d9aa0abe258883e5eb8b26d54ce2481b4e03daa3ee45f75e477423f76a`。R2-08 是行为等价的 Bot UI mixin 拆分（`bot_ui.py` 3324→867 行，新增 `bot_ui_format/jobs/archive/fixture/support`）并把 `MAX_SOURCE_FILE_LINES=1600` 源文件大小预算加入架构门禁；368 tests 全绿、独立 postflight 与 rollback-check 通过。证据见 [R2-08_RELEASE.md](evidence/R2-08_RELEASE.md)。
