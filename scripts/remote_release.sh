...
valid_release_id() {
  [[ "$1" =~ ^r2-[0-9]{2}-[0-9a-f]{7}-[0-9]{8}T[0-9]{6}Z$ ]]
}
...
rollback_release() {
  ...
  [[ "$previous_source" == "$APP_ROOT" || "$previous_source" =~ ^${RELEASE_ROOT}/r2-[0-9]{2}-[0-9a-f]{7}-[0-9]{8}T[0-9]{6}Z/source$ ]] || die "unsafe previous source path"
